...
a persistence unit "ServidorEJBPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ServidorEJB/pom.xml":
...
artifact ("ServidorEJB.war") is already built. You can build
